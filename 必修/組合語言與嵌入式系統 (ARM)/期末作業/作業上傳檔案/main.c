...
int main()
{
	...
	id[0] = (int*) malloc( sizeof( int ) );
	id[1] = (int*) malloc( sizeof( int ) );
	id[2] = (int*) malloc( sizeof( int ) );
	id[3] = (int*) malloc( sizeof( int ) );
	...
	printf( "*****Print All*****\n" );
	printf( "%s", name[0] );
	printf( "%d    %s", *id[0], name[1] );
	printf( "%d    %s", *id[1], name[2] );
	printf( "%d    %s", *id[2], name[3] );
	...
	else
	{
		...
		printf( "by  %s", name[0] );
		printf( "%d    %s", *id[1], name[1] );
		printf( "%d    %s", *id[2], name[2] );
		printf( "%d    %s", *id[3], name[3] );
